...
namespace Bko.DataAccess
{
    ...
    public partial class aspnetdbEntities1 : DbContext
    {
        public aspnetdbEntities1()
        ...
        public virtual DbSet<Action> Actionsids { get; set; }
       
    
        public virtual DbSet<Contorol> Contorols { get; set; }
   
        public virtual DbSet<ControlAct> ControlActs { get; set; }
